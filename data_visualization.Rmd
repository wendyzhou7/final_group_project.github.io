...
Our goal in this project is to visualize and analyze the SARS-CoV-2 concentrations within the 14 waste water facilities located in the New York state. However, the visualization process is not easily achieved as the NYC waste water dataset does not contain longitudinal and latitudinal information about the facilities. In order to successfully map the distribution of wastewater facilities within NYC we need to find a dataset with locational information.We found them in an international dataset "HydroWASTE" which contains the geographic data for waste water facilities in many countries, containing USA. 
...
2 literature review for two diff tech (RT-qPCR, dPCR)
